...
1. Read the **PRD File** (path specified in "Ralph Context" above)
2. Read the **Progress Log** (path specified in "Ralph Context" above, check Codebase Patterns section first)
...
APPEND to the Progress Log file (never replace, always append):
...
- Information already in the Progress Log
