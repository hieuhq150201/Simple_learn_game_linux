...
4. Save to `docs/ralph/<feature-name>/prd.md`
...
- **Format:** Markdown (`.md`)
- **Location:** `docs/ralph/<feature-name>` (kebab-case)
- **Filename:** `prd.md`
...
Add priority levels to tasks so users can focus on what matters most. Tasks can be marked as high, medium, or low
priority, with visual indicators and filtering to help users manage their workload effectively.
...
- [ ] Saved to `docs/ralph/<feature-name>/prd.md`
